...
export const BUILTIN_SPELLING: SpellRule[] = [
  ...
  // OpenAI / campus / creator English often mangled in Telugu ASR
  { from: "openaayi", to: "OpenAI" },
  { from: "openaii", to: "OpenAI" },
  { from: "openeyai", to: "OpenAI" },
  { from: "open-ai", to: "OpenAI" },
  { from: "kampas", to: "campus" },
  { from: "kaampas", to: "campus" },
  { from: "campas", to: "campus" },
  { from: "aplikeshans", to: "applications" },
  { from: "aplikeshan", to: "application" },
  { from: "applikeshan", to: "application" },
  { from: "applikeshans", to: "applications" },
  { from: "aml", to: "ML" },
  { from: "ayiemel", to: "ML" },
  { from: "aypi", to: "API" },
  { from: "eyepi", to: "API" },
  { from: "eypi", to: "API" },
  { from: "chatjipiiti", to: "ChatGPT" },
  { from: "chatgptu", to: "ChatGPT" },
  { from: "chatgpt", to: "ChatGPT" },
  { from: "instagraam", to: "Instagram" },
  { from: "linkdin", to: "LinkedIn" },
  { from: "linkdln", to: "LinkedIn" },
  { from: "whatsappu", to: "WhatsApp" },
  { from: "watsapp", to: "WhatsApp" },
  { from: "feebook", to: "Facebook" },
  { from: "fecebook", to: "Facebook" },
  { from: "twitar", to: "Twitter" },
  { from: "softveer", to: "software" },
  { from: "hardveer", to: "hardware" },
  { from: "internetu", to: "internet" },
  { from: "emeyl", to: "email" },
  { from: "imeil", to: "email" },
  { from: "paswerd", to: "password" },
  { from: "passwerd", to: "password" },
  { from: "loginu", to: "login" },
  { from: "dashbord", to: "dashboard" },
  { from: "devalapar", to: "developer" },
  { from: "devalapment", to: "development" },
  { from: "injiniyar", to: "engineer" },
  { from: "injiniyaring", to: "engineering" },
  { from: "yuniversity", to: "university" },
  { from: "studeent", to: "student" },
  { from: "studeents", to: "students" },
  { from: "skolarship", to: "scholarship" },
  { from: "intership", to: "internship" },
  { from: "internsip", to: "internship" },
  { from: "workshap", to: "workshop" },
  { from: "haakathon", to: "hackathon" },
  { from: "hakethon", to: "hackathon" },
  { from: "meetapu", to: "meetup" },
  { from: "comunitee", to: "community" },
  { from: "communiti", to: "community" },
  { from: "subskripshan", to: "subscription" },
  { from: "notifikeshan", to: "notification" },
  { from: "settengs", to: "settings" },
  { from: "settigs", to: "settings" },
  { from: "feechur", to: "feature" },
  { from: "feechurs", to: "features" },
  { from: "apdate", to: "update" },
  { from: "apdates", to: "updates" },
  { from: "daunload", to: "download" },
  { from: "daunlod", to: "download" },
  { from: "riil", to: "reel" },
  { from: "riils", to: "reels" },
  { from: "stoori", to: "story" },
  { from: "stoories", to: "stories" },
  { from: "follovers", to: "followers" },
  { from: "falovers", to: "followers" },
  { from: "engajment", to: "engagement" },
  { from: "algoritam", to: "algorithm" },
  { from: "algorithem", to: "algorithm" },
  { from: "kontent", to: "content" },
  { from: "kontentu", to: "content" },
  { from: "kriyeter", to: "creator" },
  { from: "kriyeters", to: "creators" },
  { from: "editu", to: "edit" },
  { from: "editru", to: "editor" },
  { from: "eksport", to: "export" },
  { from: "rendru", to: "render" },
  { from: "taimline", to: "timeline" },
  { from: "frayim", to: "frame" },
  { from: "frayims", to: "frames" },
  { from: "resolushan", to: "resolution" },
  { from: "kwality", to: "quality" },
  { from: "audyo", to: "audio" },
  { from: "odyo", to: "audio" },
  { from: "mikrafon", to: "microphone" },
  { from: "subtaital", to: "subtitle" },
  { from: "subtaitals", to: "subtitles" },
];
