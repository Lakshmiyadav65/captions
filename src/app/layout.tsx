...
const landingThemeInit = `(function(){try{var t=localStorage.getItem('caplio-landing-theme');if(t!=='dark'&&t!=='light'){t='light'}document.documentElement.setAttribute('data-landing-theme',t);document.documentElement.setAttribute('data-console-theme',t)}catch(e){document.documentElement.setAttribute('data-console-theme','light')}})();`;
